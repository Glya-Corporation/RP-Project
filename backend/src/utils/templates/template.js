                                                    ...
                                                    <td class="column column-1"
                                                        ...
                                                        <table border="0" cellpadding="10" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad">
                                                                    <div
                                                                        style="color:#000000;font-size:24px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-weight:700;line-height:120%;text-align:center;direction:ltr;letter-spacing:0px;mso-line-height-alt:40.8px;">
                                                                        <a style="padding: 1rem; width: 3rem, cursor: pointer" href='http://localhost:5473/#/home/verify/${data.id}'>Enlace de verificacion, click AQUI</a>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class=""
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:12px;">Cuenca, Azuay
                                                                                    EC.</span></p>
                                                                            <p
                                                                                style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                                <span
                                                                                    style="font-size:12px;">alfonsouzcategui2@gmail.com
                                                                                </span></p>
                                                                            <p
                                                                                style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 18px;">
                                                                                <span style="font-size:12px;">(+593) 97 901
                                                                                    0717</span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
